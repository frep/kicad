...
void WriteConfig()
{
	...
	EEPROM.write(350,config.sepicEnabled);
	EEPROMWriteFloat(351,config.sepicVoltage);
	EEPROMWriteInt(357,config.sepicMilliamps);
/*
	Serial.println("SepicEnabled: ");
	Serial.println(config.sepicEnabled);
	Serial.println("Voltage: ");
	Serial.println(config.sepicVoltage);
	Serial.println("Milliamps: ");
	Serial.println(config.sepicMilliamps);
*/
...
boolean ReadConfig()
{
	...
	if (EEPROM.read(0) == 'C' && EEPROM.read(1) == 'F'  && EEPROM.read(2) == 'G' )
	{
		...
		config.sepicEnabled = EEPROM.read(350);
		config.sepicVoltage = EEPROMReadFloat(351);
		config.sepicMilliamps = EEPROMReadInt(357);
/*
		Serial.println("SepicEnabled: ");
		Serial.println(config.sepicEnabled);
		Serial.println("Voltage: ");
